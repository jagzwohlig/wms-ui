                      ...
                      <form name="details" class="formPart text-left" @submit.prevent="submit">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <div
                              class="error"
                              v-if="!$v.details.releasedDate.required && $v.details.releasedDate.$error"
                        ...
                        <div>
                          ...
                          >
                            ...
                            <div
                              class="error"
                              v-if="!$v.details.assessedValue.required && $v.details.assessedValue.$error"
                        ...
                        <div>
                          ...
                          >
                            ...
                            >
                              <option value="normalEntry">normalEntry</option>
                              <option value="spillEntry">spillEntry</option>
                            </select>
                            <div
                              class="error"
                        ...
                        <div>
                          ...
                          >
                            ...
                            <div
                              class="error"
                              v-if="!$v.details.deleteStatus.required && $v.details.deleteStatus.$error"
...
export default {
  ...
  created() {
    this.getParticularOutboundById();
  },
  ...
  methods: {
    ...
    getParticularOutboundById() {
      console.log("@@@@@@@", this.$route.params.id);
      service.getOutboundDataById(this.$route.params.id, (err, result) => {
    ...
    submitFormData() {
      ...
      if (this.$v.$invalid) {
        ...
        service.editOutbound(this.details, (err, result) => {
          if (result.status === 200) {
            this.noDataFound = false;
            this.details = result.data.data;
            this.$toaster.success("Outbound Updated Successfully");
